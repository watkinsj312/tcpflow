...
CONFIG_CLEAN_FILES = tcpflow.spec
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(srcdir)/tcpflow.spec.in AUTHORS COPYING ChangeLog INSTALL \
...
STRIP = 
VERSION = 1.4.5
abs_builddir = /root/tcpflow/tcpflow-1.4.5
abs_srcdir = /root/tcpflow/tcpflow-1.4.5
...
tcpflow.spec: $(top_builddir)/config.status $(srcdir)/tcpflow.spec.in
